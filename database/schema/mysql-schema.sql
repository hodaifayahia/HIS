...
CREATE TABLE `conventions_details` (
  ...
  `avenant_id` bigint unsigned DEFAULT NULL,
  `convention_id` bigint unsigned  NULL,
...
CREATE TABLE `doctors` (
  ...
  `add_to_waitlist` tinyint(1)  NULL ,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `user_id` bigint unsigned NOT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `pharmacy_service_product_settings` (
  ...
  `min_shelf_life_days` int DEFAULT NULL,
  `max_shelf_life_days` int DEFAULT NULL,
...
CREATE TABLE `pharmacy_stockage_tools` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `pharmacy_stockage_id` bigint unsigned  NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci  NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pharmacy_storage_id` bigint unsigned DEFAULT NULL,
  `tool_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tool_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `block` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shelf_level` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `prestation_pricing` (
  ...
  `original_company_share` decimal(10,2)  NULL DEFAULT '0.00',
  `original_patient_share` decimal(10,2)  NULL DEFAULT '0.00',
  `updated_by_id` bigint unsigned  NULL,
...
CREATE TABLE `prestations` (
  ...
  `is_emergency_compatible` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `stock_movement_items` (
  ...
  `confirmation_notes` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `confirmed_at` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `confirmed_by` bigint unsigned DEFAULT NULL,
  `requested_quantity` decimal(10,2) DEFAULT NULL,
  `approved_quantity` decimal(10,2) DEFAULT NULL,
  `executed_quantity` decimal(10,2) DEFAULT NULL,
