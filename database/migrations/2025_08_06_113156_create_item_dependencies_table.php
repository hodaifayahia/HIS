...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('item_dependencies', function (Blueprint $table) {
            ...
            $table->foreignId('dependent_item_id')->nullable()->constrained('fiche_navette_items')->onDelete('cascade');
            $table->foreignId('dependent_prestation_id')->nullable()->constrained('prestations')->onDelete('cascade');
