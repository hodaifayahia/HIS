...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('pharmacy_stock_movement_items')) {
            Schema::create('pharmacy_stock_movement_items', function (Blueprint $table) {
                ...
                $table->foreign('product_id', 'psmi_product_fk')->references('id')->on('pharmacy_products')->onDelete('cascade');
                ...
                $table->index(['pharmacy_movement_id', 'status'], 'psmi_movement_status_idx');
                $table->index(['product_id', 'status'], 'psmi_product_status_idx');
            });
        }
    }
