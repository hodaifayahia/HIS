...
class UpdateModalityRequest extends FormRequest
{
    ...
    {
        $modalityId = $this->route('modality'); // Get the modality ID from the route
        ...
        return [
            ...
            'avatar' => 'nullable|image|max:2048', // For avatar file upload
            ...
            'schedules.*.number_of_patients_per_day' => 'nullable|integer',

            // Custom Dates validation
            'customDates' => 'nullable|array',
            'customDates.*.date' => 'required_with:customDates|date_format:Y-m-d',
            'customDates.*.shift_period' => 'nullable|in:morning,afternoon,evening',
            'customDates.*.start_time' => 'required_with:customDates ',
            'customDates.*.end_time' => 'required_with:customDates |after:customDates.*.start_time',
            'customDates.*.number_of_patients_per_day' => 'nullable|integer',
