...
use App\Http\Resources\PrescriptionResource; // Changed from 'prescription' to 'Prescription' for consistency
...
use App\Models\User; // Assuming this is the model for patient documents
// use PDF;

use Barryvdh\DomPDF\Facade\Pdf;
use Carbon\Carbon; // Use the correct facade
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB; // Added if you plan to use it consistently
// Added if you plan to use it consistently
use Illuminate\Support\Facades\Storage; // Added if you plan to use it consistently
use Log; // <-- IMPORTANT: Make sure this line is present
