...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = User::with(['activeSpecializations.specialization'])
            ...
            ->select(['id', 'name', 'email', 'phone', 'role', 'is_active', 'avatar', 'fichenavatte_max', 'salary', 'created_at', 'updated_at'])
    ...
    public function GetReceptionists(Request $request)
    {
        ...
        // Optimized with eager loading and specific columns
        $users = User::with(['activeSpecializations.specialization'])
    ...
    public function search(Request $request)
    {
        ...
        $users = $users->select(['id', 'name', 'email', 'phone', 'role', 'is_active', 'avatar', 'fichenavatte_max', 'salary', 'created_at', 'updated_at'])
            ->orderBy('created_at', 'desc')
            ->paginate(50);
