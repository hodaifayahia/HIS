...
use App\Models\CONFIGURATION\Service; // Import the Pavilion model
...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            } elseif ($request->filled('image_url_keep')) { // Added for explicit keeping of existing URL
    ...
    public function update(Request $request, Service $service)
    {
        try {
            ...
            } elseif ($request->input('image_url_keep') === false && $service->image_url) {
