...
export default {
  ...
  setup() {
    ...
    const loadPendingApprovals = async () => {
      try {
        const response = await axios.get('/api/stock-movements/?role=provider');
    ...
    const approveRequest = (movement) => {
      confirm.require({
        ...
        accept: async () => {
          try {
            await axios.post(`/api/stock-movements/${movement.id}/approve`);
            toast.add({
              severity: 'success',
              summary: 'Success',
    ...
    const rejectRequest = (movement) => {
      confirm.require({
        ...
        accept: async () => {
          try {
            await axios.post(`/api/stock-movements/${movement.id}/reject`);
            toast.add({
              severity: 'success',
              summary: 'Success',
    ...
    const initTransfer = (movement) => {
      confirm.require({
        ...
        accept: async () => {
          try {
            await axios.post(`/api/stock-movements/${movement.id}/init-transfer`);
            toast.add({
              severity: 'success',
              summary: 'Success',
