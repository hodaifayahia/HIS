  ...
  methods: {
    ...
    async loadMovements() {
      try {
        if (this.activeTab === 'sender') {
          ...
          const response = await axios.get('/api/pharmacy/stock-movements/?role=provider&status=pending');
          // Handle direct array response or nested data structure
    ...
    async onProductChange() {
      ...
      try {
        ...
        const response = await axios.get(`/api/pharmacy/stock-movements/${this.selectedMovement.id}/available-stock?product_id=${this.newItem.product_id}`);
    ...
    async createDraft() {
      ...
      try {
        const response = await axios.post('/api/pharmacy/stock-movements/create-draft', this.newRequest);
        this.toast.add({
          severity: 'success',
          summary: 'Success',
    ...
    async addProductToDraft() {
      ...
      try {
        await axios.post(`/api/pharmacy/stock-movements/${this.selectedMovement.id}/items`, this.newItem);
        this.toast.add({
          severity: 'success',
          summary: 'Success',
        ...
        const response = await axios.get(`/api/pharmacy/stock-movements/${this.selectedMovement.id}`);
    ...
    async removeItem(item) {
      try {
        await axios.delete(`/api/pharmacy/stock-movements/${this.selectedMovement.id}/items/${item.id}`);
        this.toast.add({
          severity: 'success',
          summary: 'Success',
