            ...
            <Column field="product.name" header="Product Name" :sortable="true">
              <template #body="slotProps">
                <div class="tw-flex tw-items-center tw-gap-3">
                  <Avatar 
                    :label="(slotProps.data.product?.name || 'P')?.charAt(0)" 
                    class="tw-bg-purple-100 tw-text-purple-700"
                    shape="square"
                  />
                  <div>
                    <div class="tw-font-semibold">{{ slotProps.data.product?.name || 'N/A' }}</div>
            ...
            >
              ...
              <div class="tw-p-4 tw-space-y-3">
                <div>
                  ...
                  <div class="tw-font-semibold tw-text-gray-800">{{ item.product?.name || 'N/A' }}</div>
                  <div class="tw-text-xs tw-text-gray-500">Code: {{ item.product?.sku || item.product?.product_code || item.product?.code_interne || 'N/A' }}</div>
                </div>
