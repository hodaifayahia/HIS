...
const fetchStockage = async () => {
  try {
    const response = await axios.get(`/api/pharmacy/stockages/${props.stockageId}`);
...
const saveTool = async () => {
  ...
  try {
    const url = showEditToolModal.value
      ? `/api/pharmacy/stockages/${props.stockageId}/tools/${editingTool.value.id}`
      : `/api/pharmacy/stockages/${props.stockageId}/tools`;
...
const confirmDelete = async () => {
  deleting.value = true;
  try {
    const response = await axios.delete(`/api/pharmacy/stockages/${props.stockageId}/tools/${toolToDelete.value.id}`);
