...
export default {
  ...
  methods: {
    async fetchStockage() {
      try {
        const response = await axios.get(`/api/pharmacy/stockages/${this.route.params.id}`);
    ...
    async addStock() {
      ...
      try {
        const response = await axios.post(`/api/pharmacy/inventory/${this.selectedInventory.id}/adjust`, {
    ...
    async transferStock() {
      ...
      try {
        const response = await axios.post(`/api/pharmacy/inventory/${this.selectedInventory.id}/transfer`, {
