...
const appDetails = {
    name: 'emergency Desk',
    icon: '/storage/emergency-icon.png', // Example icon, or use 'fas fa-clipboard-list'
    color: '#', // Example color
    backRoute: '/home'
};
...
<template>
    ...
    >
        <template #navigation>
            <li class="nav-item">
                <router-link to="/emergency/dashboard" active-class="active" class="nav-link">
            ...
            <li class="nav-item has-treeview" :class="{ 'menu-is-opening menu-open': isPatientManagementOpen}">
                ...
                <ul class="nav nav-treeview" v-show="isPatientManagementOpen">
                    <li class="nav-item">
                        <router-link to="/emergency/fiche-navette" active-class="active" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Fiche Navette</p> </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link to="/emergency/fiche-navette/custom-package" active-class="active" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
