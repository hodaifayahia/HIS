...
<template>
    ...
    >
        <template #navigation>
            <li class="nav-item">
                <router-link :to="{ name: 'manger.dashboard' }" active-class="active" class="nav-link">
            ...
            <li class="nav-item">
                <router-link :to="{ name: 'manger.prestation' }" active-class="active" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>patient Prestation </p>
                </router-link>
            </li>
