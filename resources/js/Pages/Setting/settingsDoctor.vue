          ...
          <div class="card-body box-profile">
            <div class="text-center">
              ...
              <div class="text-center">
                ...
                <img :src="user.avatar" @error="imageError" @click="$refs.avatarInput.click()"
                  class="img-circle elevation-2 mr-2 mb-2" style="height: 100px; width: 100px; object-fit: contain;"
                  alt="User Image" />
              ...
              <div class="tab-pane" id="changePassword">
                <form class="form-horizontal" @submit.prevent="updatePassword">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="password" class="form-control" id="passwordConfirmation" v-model="confirmPassword"
