...
const sidebarManifest = {
  ...
  modality: defineAsyncComponent(() => import('../../Pages/Dashborad/Sidebars/ModalitySidebar.vue')),
  ...
  externalPrescriptions: defineAsyncComponent(() => import('../../Pages/Dashborad/Sidebars/ExternalPrescriptionSidebar.vue')),
  nursing: defineAsyncComponent(() => import('../../Pages/Dashborad/Sidebars/NursingSidebar.vue')),
  planning: defineAsyncComponent(() => import('../../Pages/Dashborad/Sidebars/PlanningSidebar.vue')),
  InventoryAuditProduct: defineAsyncComponent(() => import('../../Pages/Dashborad/Sidebars/InventoryAuditSidebar.vue')),
  //   purchasing: defineAsyncComponent(() => import('../../Pages/Dashborad/Sidebars/PurchasingSidebar.vue')),
     admissions: defineAsyncComponent(() => import('../../Pages/Dashborad/Sidebars/AdmissionSidebar.vue')),
