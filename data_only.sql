...
INSERT INTO `consultation_placeholder_attributes` (`id`, `consultation_id`, `placeholder_id`, `attribute_id`, `created_at`, `updated_at`, `appointment_id`, `attribute_value`) VALUES
INSERT INTO `consultation_placeholder_attributes` (`id`, `consultation_id`, `placeholder_id`, `attribute_id`, `created_at`, `updated_at`, `appointment_id`, `attribute_value`) VALUES
INSERT INTO `doctors` (`id`, `specialization_id`, `number_of_patient`, `frequency`, `specific_date`, `notes`, `patients_based_on_time`, `time_slot`, `appointment_booking_window`, `created_by`, `user_id`, `deleted_at`, `created_at`, `updated_at`, `schedule_id`, `include_time`) VALUES
...
INSERT INTO `patients` (`id`, `Firstname`, `Lastname`, `phone`, `dateOfBirth`, `Idnum`, `Parent`, `created_by`, `deleted_at`, `created_at`, `updated_at`, `age`, `weight`, `gender`, `nss`) VALUES
INSERT INTO `patients` (`id`, `Firstname`, `Lastname`, `phone`, `dateOfBirth`, `Idnum`, `Parent`, `created_by`, `deleted_at`, `created_at`, `updated_at`, `age`, `weight`, `gender`, `nss`) VALUES
INSERT INTO `patients` (`id`, `Firstname`, `Lastname`, `phone`, `dateOfBirth`, `Idnum`, `Parent`, `created_by`, `deleted_at`, `created_at`, `updated_at`, `age`, `weight`, `gender`, `nss`) VALUES
INSERT INTO `patients` (`id`, `Firstname`, `Lastname`, `phone`, `dateOfBirth`, `Idnum`, `Parent`, `created_by`, `deleted_at`, `created_at`, `updated_at`, `age`, `weight`, `gender`, `nss`) VALUES
INSERT INTO `patients` (`id`, `Firstname`, `Lastname`, `phone`, `dateOfBirth`, `Idnum`, `Parent`, `created_by`, `deleted_at`, `created_at`, `updated_at`, `age`, `weight`, `gender`, `nss`) VALUES
...
INSERT INTO `specializations` (`id`, `name`, `description`, `photo`, `deleted_at`, `created_by`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `templates` (`id`, `name`, `mime_type`, `file_size`, `doctor_id`, `description`, `created_at`, `updated_at`, `content`, `folder_id`) VALUES
INSERT INTO `templates` (`id`, `name`, `mime_type`, `file_size`, `doctor_id`, `description`, `created_at`, `updated_at`, `content`, `folder_id`) VALUES
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `role`, `avatar`, `background`, `created_by`, `remember_token`, `deleted_at`, `created_at`, `updated_at`, `is_active`) VALUES
